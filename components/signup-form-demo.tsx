    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col space-y-4 w-full max-w-xs">
          ...
          {/* Twitter Button */}
          <button className="relative group/btn flex space-x-2 items-center justify-start px-4 py-2 rounded-md font-medium bg-zinc-900 text-neutral-300 shadow-lg hover:shadow-xl transition-all">
            <Link href="https://x.com/KrushantW32342" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
          ...
          {/* Email Button */}
          <button className="relative group/btn flex space-x-2 items-center justify-start px-4 py-2 rounded-md font-medium bg-zinc-900 text-neutral-300 shadow-lg hover:shadow-xl transition-all">
            <Link href="mailto:waghkrushant@gmail.com" className="flex space-x-2">
          ...
          {/* GitHub Button */}
          <button className="relative group/btn flex space-x-2 items-center justify-start px-4 py-2 rounded-md font-medium bg-zinc-900 text-neutral-300 shadow-lg hover:shadow-xl transition-all">
            <Link href="https://github.com/Krushan12" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
          ...
          {/* LinkedIn Button */}
          <button className="relative group/btn flex space-x-2 items-center justify-start px-4 py-2 rounded-md font-medium bg-zinc-900 text-neutral-300 shadow-lg hover:shadow-xl transition-all">
            <Link href="https://www.linkedin.com/in/krushant-wagh-703688228" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
